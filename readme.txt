...
you should do the following:
  ...
  2. Put the full path to the folder (e.g. c:\dev\glodacloud on
     Windows, /home/user/dev/glodacloud on Linux) in a file named
     glodacloud@mozillamessaging.com and copy that file to
